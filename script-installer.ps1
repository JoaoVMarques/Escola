...
if (-not (Test-Path $venvPath)) {
    ...
    Start-Process -NoNewWindow -Wait -WorkingDirectory $backEndPath -FilePath "powershell" -ArgumentList "-Command py -m venv .venv"
} else {
...
if (Test-Path $venvPython) {
    ...
    Start-Process -NoNewWindow -Wait -WorkingDirectory $backEndPath -FilePath "powershell" -ArgumentList "-Command py -m pip install -r ./requirements.txt"
}
